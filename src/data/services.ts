    ...
    serviceSectionData: [
      ...
      },
      {
        ...
        scopeOfWork: [
          ...
          "Fire safety and first aid preparation",
  ...
  // Event Security Services
  {
    ...
    heroData: {
      ...
      content: {
        ...
        description:
          "Events require a security system that is organized, responsive, and capable of managing large gatherings without disrupting the guest experience. Crown Security Agency provides specialized Event Security Services designed to ensure safety, smooth crowd flow, and controlled access across venues of all sizes.\n\nWith nearly three decades of experience managing security for corporate events, exhibitions, concerts, private functions, and public gatherings, CSA delivers a structured approach supported by trained personnel, real time supervision, and detailed planning.",
      },
      overlay: {
        enabled: true,
        color: "#252929",
